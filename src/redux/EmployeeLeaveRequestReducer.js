...
const EMPLOYEE_LEAVE_REQUEST_UPDATE_RENDER_ACTION_TYPE = "EMPLOYEE_LEAVE_REQUEST_UPDATE_RENDER_ACTION_TYPE";
...
export const updateRenderAction = (payload) => {
  ...
  // 5
  return { type: EMPLOYEE_LEAVE_REQUEST_UPDATE_RENDER_ACTION_TYPE, payload: payload };
};
...
export function EmployeeLeaveRequestReducer(state = initState, action) {
  switch (action.type) {
    ...
    case EMPLOYEE_LEAVE_REQUEST_UPDATE_RENDER_ACTION_TYPE:
      // 6
